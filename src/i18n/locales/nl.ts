export default {
  ...
  hero: {
    ...
    cta: {
      explore: 'ONTDEK ONZE EVENEMENTEN',
...
Met vriendelijke groeten`
  ...
  auth: {
    ...
    forgotPasswordNotImplemented: 'Deze functie zal binnenkort beschikbaar zijn'
  },
  dashboard: {
    title: 'Dashboard',
    welcome: 'Welkom, {name}',
    ...
    actions: {
      ...
      createEventDesc: 'Voeg een nieuw evenement toe aan de agenda',
